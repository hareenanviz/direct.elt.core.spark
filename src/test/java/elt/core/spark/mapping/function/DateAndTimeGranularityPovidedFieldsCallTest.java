 ...
 *
 */
public class DateAndTimeGranularityPovidedFieldsCallTest extends AnvizentFunctionMappingPositiveCallTest {
	...
	public HashMap<String, Object> getExpectedValues() {
		...
		expectedValues.put("Shipped_Date", getDate("2015-05-25 12:53:00.0"));
		...
		expectedValues.put("BDateTime02", getDate("2015-05-25 12:53:49.0"));
