 ...
 *
 */
public class DateAndTimeGranularityAllDateFieldsCallTest extends AnvizentFunctionMappingPositiveCallTest {
	...
	public MappingConfigBean getConfigBean() {
		...
		return new DateAndTimeGranularityConfigBean(null, getGranularities(), true);
	}
	...
	public LinkedHashMap<String, Object> getSourceValues() {
		...
		sourceValues.put("Shipped_Date", now);
		...
		sourceValues.put("BDateTime02", now);
	...
	public HashMap<String, Object> getExpectedValues() {
		...
		expectedValues.put("Sales_Order_Date", getDate("2015-05-25 12:00:00.0"));
		expectedValues.put("Shipped_Date", getDate("2015-05-25 12:00:00.0"));
		expectedValues.put("Due_Date", getDate("2015-05-25 12:00:00.0"));
		expectedValues.put("Cancelled_Date", getDate("2015-05-25 12:00:00.0"));
		expectedValues.put("Last_Invoice_Date", getDate("2015-05-25 12:00:00.0"));
		expectedValues.put("BDateTime01", getDate("2015-05-25 12:00:00.0"));
		expectedValues.put("BDateTime02", getDate("2015-05-25 12:00:00.0"));
		expectedValues.put("BDateTime03", getDate("2015-05-25 12:00:00.0"));
