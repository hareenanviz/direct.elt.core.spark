 ...
 *
 */
public class SQLLookUpDocHelper extends SQLRetrievalDocHelper {

	public SQLLookUpDocHelper(Factory factory) throws InvalidParameter {
		super(factory);
	}

	@Override
	public String[] getDescription() {
		return new String[] { "Looksup for a record from given RDBMS table based on values matching for the bellow criterias. ",
