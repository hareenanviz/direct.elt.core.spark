 ...
 *
 */
public class SQLSinkInserIfNotExistsFunction extends SQLSinkFunction {

	private static final long serialVersionUID = 1L;

	private PreparedStatement insertPreparedStatement;

	public SQLSinkInserIfNotExistsFunction(SQLSinkConfigBean sqlSinkConfigBean, LinkedHashMap<String, AnvizentDataType> structure,
