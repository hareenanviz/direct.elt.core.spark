 ...
 *
 */
public class RemoveDuplicatesByKeyPairFunction extends BaseAnvizentSymmetricPairFunction<HashMap<String, Object>, ArrayList<Object>> {

	private static final long serialVersionUID = 1L;

	public RemoveDuplicatesByKeyPairFunction(RemoveDuplicatesByKeyConfigBean configBean, LinkedHashMap<String, AnvizentDataType> structure,
	...
	public Tuple2<ArrayList<Object>, HashMap<String, Object>> process(HashMap<String, Object> row)
		...
		ArrayList<String> keyFields = ((RemoveDuplicatesByKeyConfigBean) configBean).getKeyFields();
