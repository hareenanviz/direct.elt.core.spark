 ...
 *
 */
public class PairToNormalRDDListFunction extends AnvizentPairToNormalRDDFunction<ArrayList<Object>> {

	private static final long serialVersionUID = 1L;

	public PairToNormalRDDListFunction(ConfigBean configBean, LinkedHashMap<String, AnvizentDataType> structure,
	...
	@Override
	protected BaseAnvizentErrorSetter<Tuple2<ArrayList<Object>, HashMap<String, Object>>, HashMap<String, Object>> getBaseAnvizentErrorRowSetter()
			throws InvalidArgumentsException {
		return new AnvizentSymetricPairToNormalErrorSetter<ArrayList<Object>>();
	}
}
