 ...
 *
 */
public class SourceS3CSVFileDocHelper extends DocHelper {

	public SourceS3CSVFileDocHelper(Factory factory) throws InvalidParameter {
		super(factory);
	}

	@Override
	public String[] getDescription() {
		return new String[] { "Loads CSV file(s) from given S3 bucket and from the given path.",
