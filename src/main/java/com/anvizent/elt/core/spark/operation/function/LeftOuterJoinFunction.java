...
import com.anvizent.elt.core.spark.row.formatter.LeftOuterJoinFunctionErrorSetter;
 ...
 *
 */
public class LeftOuterJoinFunction extends JoinFunction<Tuple2<HashMap<String, Object>, Optional<HashMap<String, Object>>>> {

	private static final long serialVersionUID = 1L;

	public LeftOuterJoinFunction(JoinConfigBean joinConfigBean, LinkedHashMap<String, AnvizentDataType> structure,
	...
	@Override
	public HashMap[] getRows(Tuple2<HashMap<String, Object>, Optional<HashMap<String, Object>>> row) {
	...
	@Override
	protected BaseAnvizentErrorSetter<Tuple2<HashMap<String, Object>, Optional<HashMap<String, Object>>>, HashMap<String, Object>>
			getBaseAnvizentErrorRowSetter() throws InvalidArgumentsException {
		return new LeftOuterJoinFunctionErrorSetter();
	}
}
