 ...
 *
 */
public class RethinkDBSinkInsertIfNotExistsFunction extends RethinkDBSinkFunction {

	private static final long serialVersionUID = 1L;

	public RethinkDBSinkInsertIfNotExistsFunction(RethinkDBSinkConfigBean rethinkDBSinkConfigBean, LinkedHashMap<String, AnvizentDataType> structure,
	...
	public WrittenRow process(HashMap<String, Object> row, RethinkDBSinkGetResult rethinkDBSinkGetResult)
		...
		try {
			...
			if (rethinkDBSinkGetResult.getResult() == null) {
				insertedRow = insert(row, rethinkDBSinkGetResult.getrId());
			}
	...
	private HashMap<String, Object> insert(HashMap<String, Object> row, Object rId)
		...
		Map result = insert.optArg(NOSQL.RethinkDB.CONFLICT, new RethinkDBOnConflitIgnore()).run((Connection) ApplicationConnectionBean.getInstance()
