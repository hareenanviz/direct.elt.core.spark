 ...
 *
 */
public class ArangoDBFetcherDocHelper extends ArangoDBRetrievalDocHelper {

	public ArangoDBFetcherDocHelper(Factory factory) throws InvalidParameter {
		super(factory);
	}

	@Override
	public String[] getDescription() {
		return new String[] { "Fetches and joins one or more records from given ArangoDB table based on values matching for the bellow criterias. ",
