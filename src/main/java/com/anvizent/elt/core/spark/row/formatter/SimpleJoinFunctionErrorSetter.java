 ...
 *
 */
public class SimpleJoinFunctionErrorSetter
		implements BaseAnvizentPairToNormalErrorSetter<HashMap<String, Object>, HashMap<String, Object>, HashMap<String, Object>> {

	private static final long serialVersionUID = 1L;

	public LinkedHashMap<String, Object> convertRow(JobDetails jobDetails, Tuple2<HashMap<String, Object>, HashMap<String, Object>> row,
