...
import com.anvizent.elt.core.spark.row.formatter.RightOuterJoinFunctionErrorSetter;
 ...
 *
 */
public class RightOuterJoinFunction extends JoinFunction<Tuple2<Optional<HashMap<String, Object>>, HashMap<String, Object>>> {

	private static final long serialVersionUID = 1L;

	public RightOuterJoinFunction(JoinConfigBean joinConfigBean, LinkedHashMap<String, AnvizentDataType> structure,
	...
	@Override
	public HashMap[] getRows(Tuple2<Optional<HashMap<String, Object>>, HashMap<String, Object>> row) {
	...
	@Override
	protected BaseAnvizentErrorSetter<Tuple2<Optional<HashMap<String, Object>>, HashMap<String, Object>>, HashMap<String, Object>>
			getBaseAnvizentErrorRowSetter() throws InvalidArgumentsException {
		return new RightOuterJoinFunctionErrorSetter();
	}
}
